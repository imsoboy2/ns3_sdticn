...
std::ofstream fout_t ("throughput2.txt");
...
int main (int argc, char *argv[])
{
  ...
  positionAlloc->Add (Vector (4.5, 12.5, 0));
  positionAlloc->Add (Vector (8.5, 16, 0));
  positionAlloc->Add (Vector (8.5, 8.5, 0));
  positionAlloc->Add (Vector (16.5, 16.5, 0));
  positionAlloc->Add (Vector (16.5, 8.5, 0));
  positionAlloc->Add (Vector (20, 12.5, 0));



  for (int i = 0; i < numOfTier1Switch; i++)
  {
    positionAlloc->Add (Vector (2 + rand() % 50 / 10.0, 10 + rand() % 50 / 10.0, 0));
  }

  for (int i = 0; i < numOfTier1Switch; i++)
  {
    positionAlloc->Add (Vector (6 + rand() % 50 / 10.0, 13.5 + rand() % 50 / 10.0, 0));
  }

  for (int i = 0; i < numOfTier1Switch; i++)
  {
    positionAlloc->Add (Vector (6 + rand() % 50 / 10.0, 6 + rand() % 50 / 10.0, 0));
  }

  for (int i = 0; i < numOfTier1Switch; i++)
  {
    positionAlloc->Add (Vector (14 + rand() % 50 / 10.0, 14 + rand() % 50 / 10.0, 0));
  }

  for (int i = 0; i < numOfTier1Switch; i++)
  {
    positionAlloc->Add (Vector (14 + rand() % 50 / 10.0, 6 + rand() % 50 / 10.0, 0));
  }

  for (int i = 0; i < numOfTier1Switch; i++)
  {
    positionAlloc->Add (Vector (17.5 + rand() % 50 / 10.0, 10 + rand() % 50 / 10.0, 0));
  }
